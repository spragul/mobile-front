...
export function Reset() {
    ...
    return (
        <div id='resetpageImage' className="bg-cl">
            <MDBContainer fluid className='d-flex align-items-center justify-content-center bg-image' style={{ height: '100vh' }}>     
             <MDBCard  className='m-5' style={{ maxWidth: '600px',backgroundColor: "#f0ffff00" }}>
